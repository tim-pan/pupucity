...
*/
var obj_zind = new Array();//全浴字典裝物件zindex
var obj_id=new Array();//for back to 上一步
var obj_act=new Array();//復原用array
//{“id”:上一動（就是）以下obj_note紀錄的}
...
$(function(){
    ...
    //這是拖曳確認初始位置的參數，將其設定為全域變數才不會物件要再
    //移動就又跑回去原本回來位置，每生成一個物件就會在字典多一個
    //{"e??":0}的物件作為初始offset
    var id_num_equi=0;//在函數中，讓他每產生一個物件id_num_equi就加1)
    for(var i=1; i<38; i++) {//37個設備，怕
        window['dict_xoffset_equi'+i] = new Array();//通過申明一個Array來做一個字典
        window['dict_yoffset_equi'+i] = new Array();
    }
    //這函數就是拿來點擊然後生成一個物件，酷吧
    function copy_equi(pic_src,id,www,hhh){
        
 /*

        |------------------   ------------|
        |                 |   |           |   整個div id是div_h+id_num_equi比如說"div_h8"
        |      div1       |.  |      div2 |
        |                 |   |           |     生成的物件的id是 h+id_num_equi，比如說"h8"
        |     生成的物件    |   |     工具   |     
        |    內裝div3     |   |           |       
        |                 |   |           |
        |                 |   |           |
...
<div2>
      ...
      <div class="tool" type='image' src='種子社群街區/車輛切片/上下鏡射(58X58px).png' style='略'><br>
       ...
       var dragback=document.getElementById("back_for_drag");
        ...
        div1.id="div_e"+id_num_equi;

        obj_zind["div_e"+id_num_equi]=String(zin);
/*
 ...
 */                   
        ...
        div2.id="tool_bar_equi"+id_num_equi;
        var zin=6+id_num_equi;
...
　　     obj7.remove();
    ...
    div1.addEventListener('mousedown', function(){//讓物件可以滑來滑去
            $(div1).draggable({//本來移動的時候會偏移亂跳，overstack的大神萬歲
    ...
    div1.addEventListener('dblclick',function(){show_border_equi(div1.id)});

    var obj1=document.getElementById( "e"+id_num_equi+"tool1")//縮放鎖在div
    obj1.addEventListener("click",function(){tool1_start(div1.id,div2.id)});

    var obj2=document.getElementById( "e"+id_num_equi+"tool2")//旋轉也是鎖在div
    obj2.addEventListener("click",function(){tool2(div1.id)});

    var obj3=document.getElementById( "e"+id_num_equi+"tool3")//物件往前
    obj3.addEventListener("click",function(){tool3(div1.id,div2.id)});

    var obj4=document.getElementById( "e"+id_num_equi+"tool4")//物件往前
    obj4.addEventListener("click",function(){tool4(div1.id,div2.id)});
    
    var obj5=document.getElementById( "e"+id_num_equi+"tool5")//橫的鏡射
    obj5.addEventListener("click",function(){tool5(div1.id,div3.id)});

    var obj6=document.getElementById( "e"+id_num_equi+"tool6")//直的鏡射
    obj6.addEventListener("click",function(){tool6(div1.id,div3.id)});

    var obj7=document.getElementById( "e"+id_num_equi+"tool7")//刪除
    obj7.addEventListener("click",function(){tool7(div1.id,div2.id)});

/*
    var obj7=document.getElementById( "h"+id_num_equi+"tool6")//刪除
    obj7.addEventListener("click",function(){tool6(table.id)});
*/

    $(document).mouseup(function(e) //點擊空白處框框消失加工具結束
    {
        var container = $(div1);
        var tool1=$("e"+id_num_equi+"tool1");
    ...
    document.getElementById("imageField10").addEventListener('click',function(){back_act(obj_act,obj_id)});

    document.getElementById("equi1").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備1(106.86X266.42px).png","equi1",106.86,266.42)});

    document.getElementById("equi2").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備2(84.75X270.06px).png","equi2",84.75,270.06)});

    document.getElementById("equi3").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備6(86.54X276.81px).png","equi6",86.54,276.81)});

    document.getElementById("equi4").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備7(123.9X278.5px).png","equi7",123.9,278.5)});

    document.getElementById("equi5").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備3(149.36X273.24px).png","equi3",149.36,273.24)});

    document.getElementById("equi6").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備4(84.75X270.06px).png","equi4",84.75,270.06)});

    document.getElementById("equi7").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備5(106.86X266.42px).png","equi5",106.86,266.42)});

    document.getElementById("equi8").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備8(77.97X281.17px).png","equi8",77.97,281.17)});

    document.getElementById("equi9").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備9(136.16X281.17px).png","equi9",136.16,281.17)});

    document.getElementById("equi10").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備10(131.04X278.37px).png","equi10",131.04,278.37)});

    document.getElementById("equi11").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備11(142.98X276.81px).png","equi11",142.98,276.81)});

    document.getElementById("equi12").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備12(142.03X272.9px).png","equi12",142.03,272.9)});

    document.getElementById("equi13").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備13(46.56X212.48px).png","equi13",46.56,212.48)});

    document.getElementById("equi14").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備14(56.04X233.72px).png","equi14",56.04,233.72)});

    document.getElementById("equi15").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備15(113.48X95.63px).png","equi15",113.48,95.63)});

    document.getElementById("equi16").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備16(124.28X111.94px).png","equi16",124.28,111.94)});

    document.getElementById("equi17").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備17(107.86X122.3px).png","equi17",107.86,122.3)});

    document.getElementById("equi18").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備18(78.22X122.3px).png","equi18",78.22,122.3)});

    document.getElementById("equi19").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備19(73.84X115.03px).png","equi19",73.84,115.03)});

    document.getElementById("equi20").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備20(498.73X81.06px).png","equi20",498.73,81.06)});

    document.getElementById("equi21").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備21(236.47X43px).png","equi21",236.47,43)});

    document.getElementById("equi22").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備22(250.25X91.31px).png","equi22",250.25,91.31)});

    document.getElementById("equi23").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備23(257.71X78.61px).png","equi23",257.71,78.61)});

    document.getElementById("equi24").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備24(208.63X83.15px).png","equi24",208.63,83.15)});

    document.getElementById("equi25").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備25(168.36X118.29px).png","equi25",168.36,118.29)});

    document.getElementById("equi26").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備26(389.39X186.31px).png","equi26",389.39,186.31)});

    document.getElementById("equi27").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備27(675.79X261.36px).png","equi27",675.79,261.36)});

    document.getElementById("equi28").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備28(457.79X293.2px).png","equi28",457.79,293.2)});

    document.getElementById("equi29").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備29(536.84X279.01px).png","equi29",536.84,279.01)});

    document.getElementById("equi30").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備30(455.69X218.04px).png","equi30",455.69,218.04)});

    document.getElementById("equi31").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備31(680.18X255.96px).png","equi31",680.18,255.96)});

    document.getElementById("equi32").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備32(848.65X354.12px).png","equi32",424,172)});

    document.getElementById("equi33").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備33(815.7X262.28px).png","equi33",408,131)});

    document.getElementById("equi34").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備34(51.85X258.33px).png","equi34",51.85,258.33)});

    document.getElementById("equi35").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備35(51.85X258.33px).png","equi35",51.85,258.33)});

    document.getElementById("equi36").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備36(191.51X109.08px).png","equi36",191.51,109.08)});

    document.getElementById("equi37").addEventListener('click',function(){
    copy_equi("種子社群街區/設備切片/實際大小/設備37(68.25X129.36px).png","equi37",68.25,129.36)});
